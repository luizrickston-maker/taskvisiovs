...
const formSchema = z.object({
  ...
  content_link: z.string().url('URL inválida').optional().or(z.literal('')).or(z.literal(null)),
  ...
  status: z.enum(['idea', 'draft', 'review', 'approved', 'published']).optional().default('idea'),
  assigned_to: z.string().optional().or(z.literal(null)),
});
