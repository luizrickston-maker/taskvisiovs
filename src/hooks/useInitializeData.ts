...
import type { Category, Income, Expense, Debt, Saving, Goal, Task, TimeBlock, ProjectCategory, Project, Script, UserPreference } from '@/types/database';
...
export function useInitializeData(userId: string | undefined) {
  ...
  useEffect(() => {
    ...
    loadAllData();
  }, [userId, dataInitialized, setCategories, setIncomes, setExpenses, setDebts, setSavings, setGoals, setTasks, setTimeBlocks, setProjectCategories, setProjects, setScripts, setUserPreferences, setIsLoading, setDataInitialized]);
}
